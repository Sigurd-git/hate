...
\begin{figure}[t]
  ...
  \caption{Schematic of the rating design. Human participants were randomly assigned to one response scale, whereas each LLM completed ratings under all three response scales.}
